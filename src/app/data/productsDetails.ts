...
const products: Product[] = [
  ...
  {
    id: 2,
    title: "Classic Tailored Gurkhas",
  ...
  },
  {
    id: 3,
    title: " Casual Shirts",
    description: "Effortlessly stylish, these  Drab shirts is cut from high-quality linen. Designed for the modern man, it features a relaxed fit ensuring comfort throughout the day while maintaining a crisp look. Pairs perfectly with our Gurkha pants.",
    price: 799,
    size: "L",
    fabric: "linen",
    color: "olive",
